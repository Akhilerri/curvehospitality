...
export default function Services() {
  ...
  usePageSEO(
      ...
      : 'Comprehensive hospitality services including interior design, FF&E manufacturing, procurement, and project management for hotels and restaurants.',
    {
      keywords: selectedService 
        ? [selectedService.title, selectedService.type, 'hospitality services']
        : ['hospitality services', 'interior design services', 'FF&E manufacturing', 'procurement services', 'project management'],
      breadcrumbs: selectedService 
        ? [
            { name: 'Home', url: '/' },
            { name: 'Services', url: '/services' },
            { name: selectedService.title, url: `/services/${selectedService.id}` }
          ]
        : [
            { name: 'Home', url: '/' },
            { name: 'Services', url: '/services' }
  ...
  const handleContactClick = () => {
    // In a real app, this would navigate to contact page or open contact modal
    alert('Contact functionality would be implemented here - navigate to contact page or open contact modal');
  };

  const handleQuoteClick = () => {
    // In a real app, this would navigate to quote request page or open quote modal
    alert('Quote request functionality would be implemented here - navigate to quote form or open quote modal');
  };
